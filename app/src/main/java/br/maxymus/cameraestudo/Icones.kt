...
object Icones {
    ...
    // ---------------- exclusivos da câmera (mesmo sistema, arquivo idêntico nos dois apps) ----------------

    /** Auto-máscaras: contorno irregular em volta do objeto, com a centelha da detecção automática. */
    val AutoMascaras = icone("auto_mascaras") {
        moveTo(4.2f, 12.5f)
        curveTo(3.6f, 8.5f, 7f, 5.2f, 11f, 5.6f); curveTo(15.5f, 6f, 17.8f, 9f, 17.4f, 13f)
        curveTo(17.1f, 16.6f, 13.6f, 19.2f, 10f, 18.6f); curveTo(6.6f, 18f, 4.7f, 15.8f, 4.2f, 12.5f); close()
        circulo(10.6f, 12.2f, 3.2f)
        linha(19.4f, 3f, 19.4f, 6.4f); linha(17.7f, 4.7f, 21.1f, 4.7f)
    }

    /** Aparelho: o celular, para o efeito que vem do próprio fabricante. */
    val Aparelho = icone("aparelho") {
        moveTo(8f, 2.8f); lineTo(16f, 2.8f); arcTo(1.8f, 1.8f, 0f, false, true, 17.8f, 4.6f); lineTo(17.8f, 19.4f)
        arcTo(1.8f, 1.8f, 0f, false, true, 16f, 21.2f); lineTo(8f, 21.2f)
        arcTo(1.8f, 1.8f, 0f, false, true, 6.2f, 19.4f); lineTo(6.2f, 4.6f)
        arcTo(1.8f, 1.8f, 0f, false, true, 8f, 2.8f); close()
        linha(10.5f, 5.6f, 13.5f, 5.6f)
        circulo(12f, 18.2f, 0.9f)
    }

    /** Registro: a folha do que já foi digitalizado, com o relógio do histórico. */
    val Registro = icone("registro") {
        moveTo(4.5f, 3.5f); lineTo(15f, 3.5f); lineTo(19f, 7.5f); lineTo(19f, 13f)
        moveTo(4.5f, 3.5f); lineTo(4.5f, 20.5f); lineTo(12f, 20.5f)
        linha(14.8f, 3.6f, 14.8f, 7.5f); linha(14.8f, 7.5f, 18.9f, 7.5f)
        linha(7.5f, 10f, 15f, 10f); linha(7.5f, 13f, 12.5f, 13f)
        circulo(17f, 17.5f, 4f)
        linha(17f, 15.3f, 17f, 17.5f); linha(17f, 17.5f, 18.7f, 18.4f)
    }
