...
/**
 * Atualização dentro do app, igual à câmera: o CI publica um releases.json no R2 (versão, versionCode, link do APK);
 * o app compara com a própria versão e, se houver algo mais novo, baixa pelo DownloadManager e abre o instalador.
 */
object Atualizador {
    private const val URL_MANIFESTO = "https://pub-520120b0b03b4d3f8c94c5c9ba10d569.r2.dev/galeria-estudo/releases.json"
