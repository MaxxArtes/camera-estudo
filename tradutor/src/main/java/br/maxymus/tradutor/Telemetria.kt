...
/**
 * Telemetria do estudo (mesmo coletor e desenho da câmera; app "tradutor"): eventos com tempos, contagens e
...
object Telemetria {
    ...
    fun evento(tipo: String, campos: Map<String, Any?> = emptyMap()) {
        ...
        val linha = JSONObject().apply {
            put("app", "tradutor"); put("versao", versao); put("id", idAparelho)
